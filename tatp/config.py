...
SCHEMA: tuple[tuple[str, str, type | tuple[type, ...], float | None, float | None], ...] = (
    ...
    ("study1.yaml", "choice.feedback_s", NUMBER, 0, None),
    ("study1.yaml", "choice.gap_s", NUMBER, 0, None),
    ...
    ("study1.yaml", "pinprick.start_filament_label_g_session1_pre_s", str, None, None),
    ("study1.yaml", "pinprick.intolerable_vas_pct", NUMBER, 0, 100),
    ("study1.yaml", "pinprick.intolerable_sites_for_global_cap", int, 1, None),
    ...
    ("study1.yaml", "pinprick.expected_offset_steps_between_sessions", NUMBER, None, None),
    ("study1.yaml", "brush.isi_min_s", NUMBER, 0, None),
    ("study1.yaml", "brush.isi_max_s", NUMBER, 0, None),
    ("study1.yaml", "brush.rating_cue_delay_s", NUMBER, 0, None),
    ("study1.yaml", "brush.rating_scale", str, None, None),
    ("study1.yaml", "mapping.n_paths", int, 1, None),
    ("study1.yaml", "mapping.path_ids[*]", str, None, None),
    ...
    ("study1.yaml", "fit_preview.enabled", bool, None, None),
    ("study1.yaml", "fit_preview.procedures", list, None, None),
    ...
    ("study1.yaml", "touch_calibration.estimation_settle_s", NUMBER, 0, None),
    ("study1.yaml", "touch_calibration.estimation_iti_min_s", NUMBER, 0, None),
    ("study1.yaml", "touch_calibration.estimation_iti_max_s", NUMBER, 0, None),
    ("study1.yaml", "touch_calibration.catch_felt_min_pct", NUMBER, 0, 100),
    ("study1.yaml", "touch_calibration.stage1.min_span_vas", NUMBER, 0, 100),
    ("study1.yaml", "touch_calibration.stage1.min_spearman_rho", NUMBER, -1, 1),
    ...
    ("study1.yaml", "patterns.fixed_ct_pattern", str, None, None),
    ...
    ("hardware.yaml", "garment.prototype.port", str, None, None),
    ("hardware.yaml", "garment.prototype.baud", int, 1, None),
    ("hardware.yaml", "garment.prototype.boot_s", NUMBER, 0, None),
    ("hardware.yaml", "garment.prototype.channel_bits[*]", int, 0, 31),
    ("hardware.yaml", "prototype_command_file.max_steps", int, 1, None),
    ("hardware.yaml", "prototype_command_file.max_step_ms", int, 1, None),
    ("hardware.yaml", "prototype_command_file.mask_bits", int, 1, None),
    ...
    ("hardware.yaml", "audio.output_channels", int, 1, None),
    ("hardware.yaml", "audio.tone_ramp_s", NUMBER, 0, None),
    ("hardware.yaml", "audio.noise_hold_rate_initial_db_s", NUMBER, 0, None),
    ("hardware.yaml", "audio.noise_hold_rate_final_db_s", NUMBER, 0, None),
    ("hardware.yaml", "audio.sample_rate_hz", int, 1, None),
    ("hardware.yaml", "audio.white_noise_start_dbfs", NUMBER, None, 0),
    ("hardware.yaml", "audio.white_noise_max_dbfs", NUMBER, None, 0),
    ("hardware.yaml", "audio.white_noise_step_db", NUMBER, 0, None),
    ("hardware.yaml", "audio.masking_check_pressure_kpa", NUMBER, 0, None),
    ("hardware.yaml", "audio.masking_check_max_attempts", int, 1, None),
    ("hardware.yaml", "audio.participant_cue_hz", NUMBER, 0, None),
    ("hardware.yaml", "audio.participant_cue_duration_s", NUMBER, 0, None),
    ("hardware.yaml", "audio.participant_cue_over_noise_db", NUMBER, 0, None),
