...
| # | What | Gate | Ref |
|---|---|---|---|
| A2.1 | **Software pressure ceiling.** 200 kPa is in place as a working value below the 250 kPa hardware maximum, and is not an agreed limit. Give a number or confirm it stands. | Real participant | L1 |
...
| A2.3 | **Audio levels** — white noise, participant cue, experimenter alert, in dBFS. Needs a meter at the headphones: the cue audible over the noise, the alert not audible to the participant. | Real participant | L3 |
